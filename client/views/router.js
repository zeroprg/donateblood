...
var privateRoutes = [
	"home_private",
	"home_private.donors",
	"home_private.donors.insert",
	"home_private.donors.details",
	"home_private.donors.edit",
	"user_settings",
...
Router.map(function () {
	...
	this.route("home_private.donors", {path: "/home_private/donors", controller: "HomePrivateDonorsController"});
	this.route("home_private.donors.insert", {path: "/home_private/donors/insert", controller: "HomePrivateDonorsInsertController"});
	this.route("home_private.donors.details", {path: "/home_private/donors/details/:donorId", controller: "HomePrivateDonorsDetailsController"});
	this.route("home_private.donors.edit", {path: "/home_private/donors/edit/:donorId", controller: "HomePrivateDonorsEditController"});
